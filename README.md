...
> [!WARNING]
> This package is pinned to `@modelcontextprotocol/sdk@1.10.2` to ensure compatibility and stability. Using a different version may cause unexpected behavior.
